...
{      
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var shoppingContext = _context.Orders.Include(o => o.Customer).ThenInclude(o=>o.user).Include(s=>s.SuperMarket).AsQueryable();
            
            if (!User.IsInRole("admin"))
            {
                var userEmail = User.FindFirst(u => u.Type == ClaimsIdentity.DefaultNameClaimType).Value;
                var orders = shoppingContext.Where(o => o.Customer.user.Email.ToLower() == userEmail.ToLower());
